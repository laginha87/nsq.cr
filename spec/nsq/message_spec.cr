...
macro tcp_server_eq(message, &block)
  ...
  server = TCPServer.new("localhost", 51_234)
  spawn do
...
module NSQ
  describe Message do
    it "initializes" do
      message = Message.new(attempts: 1.to_u16, id: "1", timestamp: 10_000.to_i64, body: "body", connection: nil)
      message.attempts.should eq 1
      message.id.should be "1"
      message.timestamp.should eq 10_000
